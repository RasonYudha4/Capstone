...
export default function ResetPassword() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const message = error instanceof Error ? error.message : "Gagal reset password. Mungkin link sudah kadaluarsa.";
            toast.error(message);
        } finally {
                ...
                <Card className="w-full max-w-md border-none shadow-2xl rounded-3xl overflow-hidden animate-in fade-in zoom-in duration-500">
                    ...
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-gray-500 mb-8 leading-relaxed">
                            Password Anda telah diperbarui. Semua sesi lama telah di-logout. Silakan login dengan password baru.
                        </p>
                        <Button
            ...
            <Card className="w-full max-w-md border-none shadow-2xl rounded-3xl overflow-hidden">
                <CardHeader className="bg-[#6B5FAE] text-white p-8 space-y-2">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-sm font-medium tracking-wider uppercase opacity-80">Reset Password</span>
                    </div>
