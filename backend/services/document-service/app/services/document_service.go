...
func (d *DocumentService) Get_document_by_standard(standardId, createdById uuid.UUID, page, limit int) ([]schemas.DocumentResponse, int, int, error) {
	page, limit, offset := pageLimit(page, limit)
	docs, err := d.repo.Get_document_by_standard(standardId, createdById, limit, offset)
	if err != nil {
		return []schemas.DocumentResponse{}, 0, 0, err
	}
	return docs, page, limit, nil
...
func (d *DocumentService) Get_document_by_service(serviceId, createdById uuid.UUID, page, limit int) ([]schemas.DocumentResponse, int, int, error) {
	page, limit, offset := pageLimit(page, limit)
	docs, err := d.repo.Get_document_by_service(serviceId, createdById, limit, offset)
	if err != nil {
		return []schemas.DocumentResponse{}, 0, 0, err
	}
	return docs, page, limit, nil
...
func (d *DocumentService) Get_document_by_assessment(assessmentId, createdById uuid.UUID, page, limit int) ([]schemas.DocumentResponse, int, int, error) {
	page, limit, offset := pageLimit(page, limit)
	docs, err := d.repo.Get_document_by_assessment(assessmentId, createdById, limit, offset)
	if err != nil {
		return []schemas.DocumentResponse{}, 0, 0, err
	}
	return docs, page, limit, nil
